...
// JS functions on the relevant QRVM hooks. It uses Goja as its JS engine.
...
func (t *jsTracer) CaptureStart(env *vm.QRVM, from common.Address, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
	t.env = env
...
// and returns an error. It in turn pings the QRVM to cancel its
// execution.
