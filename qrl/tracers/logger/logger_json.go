...
// NewJSONLogger creates a new QRVM tracer that prints execution steps as JSON objects
...
func (l *JSONLogger) CaptureStart(env *vm.QRVM, from, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
	l.env = env
}
