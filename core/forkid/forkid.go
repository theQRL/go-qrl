...
// NewID calculates the QRL fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the QRL fork ID from an existing chain instance.
