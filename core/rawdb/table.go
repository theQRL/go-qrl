...
func NewTable(db qrldb.Database, prefix string) qrldb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(qrldb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader qrldb.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) qrldb.Iterator {
...
func (t *table) NewBatch() qrldb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) qrldb.Batch {
...
func (b *tableBatch) Replay(w qrldb.KeyValueWriter) error {
