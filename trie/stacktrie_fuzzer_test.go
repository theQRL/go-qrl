...
func fuzz(data []byte, debugging bool) {
	var (
		...
		trieB   = NewStackTrie(func(owner common.Hash, path []byte, hash common.Hash, blob []byte) {
	...
	var (
		...
		trieC   = NewStackTrie(func(owner common.Hash, path []byte, hash common.Hash, blob []byte) {
