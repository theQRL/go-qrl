...
// implementation.
func TestDatabaseSuite(t *testing.T, New func() qrldb.KeyValueStore) {
...
// implementation.
func BenchDatabaseSuite(b *testing.B, New func() qrldb.KeyValueStore) {
	var (
...
func iterateKeys(it qrldb.Iterator) []string {
	keys := []string{}
	for it.Next() {
