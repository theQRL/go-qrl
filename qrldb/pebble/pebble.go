...
func (d *Database) NewBatch() qrldb.Batch {
	return &batch{
		b:  d.db.NewBatch(),
		db: d,
	}
...
func (d *Database) NewBatchWithSize(size int) qrldb.Batch {
	return &batch{
...
func (b *batch) Replay(w qrldb.KeyValueWriter) error {
	reader := b.b.Reader()
	for {
...
func (d *Database) NewIterator(prefix []byte, start []byte) qrldb.Iterator {
