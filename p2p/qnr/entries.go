...
func (g generic) QNRKey() string { return g.key }
...
func (v ID) QNRKey() string { return "id" }
...
func (v IPv4) QNRKey() string { return "ip" }
...
func (v IPv6) QNRKey() string { return "ip6" }
