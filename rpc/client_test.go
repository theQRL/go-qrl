	...
	check := func(shouldPanic bool, arg any) {
		defer func() {
			...
			if shouldPanic && err == nil {
				t.Errorf("QRLSubscribe should've panicked for %#v", arg)
			}
			if !shouldPanic && err != nil {
				t.Errorf("QRLSubscribe shouldn't have panicked for %#v", arg)
...
// This test reproduces https://github.com/theQRL/go-zond/issues/17837 where the
...
// It is the reproducer for https://github.com/theQRL/go-zond/issues/22322
